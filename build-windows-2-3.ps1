...
########################################################################################################################
pandoc -V geometry:margin=1in -s -o ./output/pdf/Understanding-the-Technology-and-Philosophy-of-Linux-Part-II-2-3-$STAMP.pdf ./Chapter-02/chapter-02.md ./Chapter-03/chapter-03.md 
